...
| **PartitioningDB**| <img src="./img/DBpartitioning.png" width="500" loading="lazy" alt="PartitioningDB 썸네일"/>  | 대용량 데이터를 파티셔닝 기법으로 분할하여 조회 성능을 비교하고, 실행 계획 분석을 통해 최적화 방안을 탐구한 실험 프로젝트 | [GitHub](https://github.com/Minkyoungg0/PartitioningDB.git)  |
